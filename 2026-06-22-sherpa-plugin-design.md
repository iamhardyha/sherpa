...
> 작성일: 2026-06-22 · 갱신: 2026-06-24 (rev 12 — graph.json 파생 스키마+질의 인터페이스 §4.7: 노드·엣지·파생 사실·명명 질의(O(1) 슬라이스) · rev 11 메타데이터 계약 §2.8 · rev 10 실행 모드 §4.6 · rev 9 트리비얼 §6-D) · 상태: 설계 승인 대기
